...
from engine.runtime import run_pygfx_hosted_runtime
...
def run_engine_hosted_app() -> None:
    ...
    run_pygfx_hosted_runtime(module_factory=lambda renderer, layout: _build_module(controller, renderer, layout, debug_ui))
