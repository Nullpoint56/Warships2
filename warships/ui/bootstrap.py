...
from warships.ui.framework.engine import UIFrameworkEngine
...
class PygfxFrontendWindow(FrontendWindow):
    ...
    def __init__(self, controller: GameController) -> None:
        ...
        self._framework = UIFrameworkEngine(controller=self._controller, renderer=self._renderer, layout=self._layout)
