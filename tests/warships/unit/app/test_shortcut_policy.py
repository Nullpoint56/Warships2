...
def test_shortcut_policy_by_state() -> None:
    ...
    assert shortcut_buttons_for_state(AppState.NEW_GAME_SETUP) == {
        "enter": "start_game",
        "escape": "back_main",
    }
    assert shortcut_buttons_for_state(AppState.PRESET_MANAGE) == {
        "enter": "create_preset",
        "escape": "back_main",
    }
    assert shortcut_buttons_for_state(AppState.PLACEMENT_EDIT) == {
        "enter": "save_preset",
        "escape": "back_to_presets",
    }
